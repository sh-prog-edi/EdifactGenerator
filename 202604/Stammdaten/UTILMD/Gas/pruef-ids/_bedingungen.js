...
//
// Enthält alle 147 im UTILMD-Gas-AHB G1.1 (Stand 27.03.2026) definierten Bedingungen als Text, plus
...
// über alle Fundstellen, datengetriebene Wortnaht-Reparatur). 92 schwer aus dem
...
//
// Quelle: UTILMD-Gas-AHB G1.1 (Stand 27.03.2026) + Allgemeine Festlegungen.
...
// Alle 147-AHB-Bedingungstexte (extrahiert; Schlüssel = Bedingungsnummer als String).
var bedingungTexte = {
    ...
    "44": "Wenn im selben Segment im DE2379 der Code 106 vorhanden ist",
    ...
    "77": "Wenn SG8 SEQ+Z03 ∧ [584] (Zähleinrichtungsdaten) CAV+Z30 (Identifikation/Nummer des Gerätes) nicht vorhanden",
    ...
    "362": "IMD++Z36+Z12 (Identifikationslogik: Marktlokations-ID) vorhanden",
    ...
    "502": "Hinweis: \nErsatzbelieferung gibt es nur bei \n- Marktlokationen in der  Niederdruckebene, die kein Haushaltskunde gem. EnWG sind und die nicht mehr der gesetzlichen Ersatzversorgung (drei Monate) unterliegen und \n- für Marktlokationen, die in Mitteldruck einer Versorgung zugeführt werden sollen. Grundlage für eine Ersatzbelieferung ist die bilaterale Vereinbarung",
    ...
    "527": "Hinweis: Es ist die ∧ [583] ID der Marktlokation und alle Identifikatoren der Messlokationen anzugeben",
