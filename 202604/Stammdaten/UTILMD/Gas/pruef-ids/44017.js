// 44017.js  (UTILMD Gas, GeLi Gas) - Kündigung – Bestätigung (LFA an LFN)
...
const ahbRules44017 = {
    ...
    segments: [
        ...
        { id: "DTM_93", name: "SG4 DTM+93: Ende zum", status: "Bedingt", ahbExpr: "Muss [12] ∧ [13]", rule: "Entweder DTM+93 oder DTM+471 (nächstmöglicher Termin)." },
...
if (typeof module !== 'undefined') module.exports = ahbRules44017;
