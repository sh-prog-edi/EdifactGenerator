// 44175.js  (UTILMD Gas) - Änderung der Marktlokationsstruktur
...
const ahbRules44175 = {
    ...
    segments: [
        ...
        { id: "LOC_172", name: "SG5 LOC+172: Meldepunkt (Marktlokation/Zählpunkt)", status: "Muss", ahbExpr: "Muss [590]" },
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss-bedingt", isSelect: true, options: [{ v: "ZI9", t: "ZI9 - Änderung der komplexen Marktlokationsstruktur" }], ahbExpr: "Muss [2061]", rule: "AHB: Muss [2061]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules44175;
