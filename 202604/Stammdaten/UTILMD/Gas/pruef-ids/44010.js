// 44010.js  (UTILMD Gas, GeLi Gas) - Abmeldeanfrage (LF an NB)
...
const ahbRules44010 = {
    ...
    segments: [
        ...
        { id: "DTM_93", name: "SG4 DTM+93: Ende zum", status: "Muss" },
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss-bedingt", isSelect: true, options: [{ v: "E01", t: "E01 - Ein-/Auszug (Umzug)" }, { v: "E03", t: "E03 - Wechsel" }, { v: "ZD2", t: "ZD2 - Lieferbeginn und Abmeldung aus der Ersatzversorgung" }], ahbExpr: "Muss [2061] ∧ [644]", rule: "AHB: Muss [2061] ∧ [644]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules44010;
