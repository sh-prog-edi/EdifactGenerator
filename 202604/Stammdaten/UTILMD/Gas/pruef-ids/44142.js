...
const ahbRules44142 = {
    ...
    segments: [
        ...
        { id: "DTM_155", name: "SG4 DTM+155: Start des Abrechnungsjahrs bei Marktlokationen mit Jahresleistungspreis", status: "Soll", ahbExpr: "Soll [202] ∧ [336]", rule: "AHB: Soll [202] ∧ [336]" },
        { id: "DTM_Z21", name: "SG4 DTM+Z21: Termin der Netznutzungsabrechnung", status: "Soll", ahbExpr: "Soll [202] ∧ [336]", rule: "AHB: Soll [202] ∧ [336]" },
        { id: "DTM_Z09", name: "SG4 DTM+Z09: Netznutzungsabrechnung", status: "Muss-bedingt", ahbExpr: "Muss [24] ∧ [230]", rule: "AHB: Muss [24] ∧ [230]" },
        { id: "DTM_Z22", name: "SG4 DTM+Z22: Netznutzungsabrechnungsi ntervall des NB", status: "Soll", ahbExpr: "Soll [202] ∧ [336] · Codes: Z22 [504]", rule: "AHB: Soll [202] ∧ [336]" },
