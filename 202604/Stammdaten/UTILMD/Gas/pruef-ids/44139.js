...
const ahbRules44139 = {
    ...
    segments: [
        ...
        { id: "DTM_155", name: "SG4 DTM+155: Start des Abrechnungsjahrs bei Marktlokationen mit Jahresleistungspreis", status: "Kann", rule: "AHB: Kann" },
        { id: "DTM_Z21", name: "SG4 DTM+Z21: Termin der Netznutzungsabrechnung", status: "Kann", rule: "AHB: Kann" },
        { id: "DTM_Z09", name: "SG4 DTM+Z09: Netznutzungsabrechnung", status: "Kann", rule: "AHB: Kann" },
        { id: "DTM_Z22", name: "SG4 DTM+Z22: Netznutzungsabrechnungsi ntervall des NB", status: "Kann", ahbExpr: "Codes: Z22 [504]", rule: "AHB: Kann" },
