// 44103.js  (UTILMD Gas) - Stammdaten zur verbrauchenden
...
const ahbRules44103 = {
    ...
    segments: [
        ...
        { id: "DTM_92", name: "SG4 DTM+92: Beginn zum", status: "Muss-bedingt", ahbExpr: "Muss [508]", rule: "AHB: Muss [508]" },
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss-bedingt", isSelect: true, options: [{ v: "ZE5", t: "ZE5 - Initialmeldung" }], ahbExpr: "Muss [2061]", rule: "AHB: Muss [2061]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules44103;
