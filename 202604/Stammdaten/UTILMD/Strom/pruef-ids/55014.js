// 55014.js - Bestätigung EoG-Anmeldung (LF an NB)
// Segmentregeln für Prüf-ID 55014 (AHB Strom S2.1, konsolidierte Lesefassung Stand 29.06.2026).
...
const ahbRules55014 = {
    ...
    segments: [
        ...
        { id: "STS_7", name: "SG4 STS+7: Transaktionsgrundergänzung", status: "Muss", isSelect: true, options: [{ v: "ZW4", t: "ZW4 - Verbrauchende Marktlokation" }], ahbExpr: "Codes: E06 [580], ZZD [313], ZZD [681], E01 [9P0..1], E03 [9P0..1]" },
        { id: "STS_E01", name: "SG4 STS+E01: Status der Antwort (Zustimmung, EBD E_0615)", status: "Muss" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55014;
