// 55064.js - Antwort Aktivierung/Deaktivierung MaBiS-ZP
// Segmentregeln für Prüf-ID 55064 (AHB Strom S2.1, Stand 29.06.2026, Kap. 13.1).
...
const ahbRules55064 = {
    ...
    segments: [
        ...
        { id: "DTM_158", name: "SG4 DTM+158: Bilanzierungsbeginn", status: "Soll", ahbExpr: "Soll [30]", rule: "AHB: Soll [30]" },
        { id: "DTM_159", name: "SG4 DTM+159: Bilanzierungsende", status: "Soll", ahbExpr: "Soll [34]", rule: "AHB: Soll [34]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules55064;
