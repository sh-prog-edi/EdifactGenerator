// 55666.js - Rückmeldung/Anfrage Daten der Steuerbare Ressource (SR) (weiterer MSB an MSB)
// Segmentregeln für Prüf-ID 55666 (AHB Strom S2.1, Stand 29.06.2026, Stammdatenänderung verantwortlich MSB).
...
const ahbRules55666 = {
    ...
    segments: [
        ...
        { id: "LOC_Z19", name: "SG5 LOC+Z19: ID der Steuerbaren Ressource", status: "Muss", ahbExpr: "Muss [2061]" },
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX9", t: "ZX9 - Änderung Daten der SR" }], rule: "AHB: Muss" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55666;
