...
// Kern-Segmentregeln für Prüf-ID 55614 (AHB Strom S2.1, Abrechnungsdaten).
...
const ahbRules55614 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX3", t: "ZX3 - Abrechnungsdaten BK-Abrechnung verbrauchender MaLo" }, { v: "ZAN", t: "ZAN - Korrektur Abrechnungsdaten BK-Abrechnung verbrauchender MaLo" }], rule: "AHB: Muss" },
