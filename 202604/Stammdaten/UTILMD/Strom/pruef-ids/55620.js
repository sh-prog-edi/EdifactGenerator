// 55620.js - Änderung Daten der Messlokation (MeLo) (NB an LF)
// Segmentregeln für Prüf-ID 55620 (AHB Strom S2.1, Stand 29.06.2026, Stammdatenänderung).
...
const ahbRules55620 = {
    ...
    segments: [
        ...
        { id: "LOC_Z17", name: "SG5 LOC+Z17: ID der Messlokation", status: "Muss", ahbExpr: "Muss [2061]" },
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX7", t: "ZX7 - Änderung Daten der MeLo" }], rule: "AHB: Muss" },
        ...
        { id: "RFF_Z05", name: "SG6 RFF+Z05: Abrechnung des Messstellenbetriebs über NNE", status: "Muss-bedingt", ahbExpr: "Muss [508]", rule: "AHB: Muss [508]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules55620;
