// 55626.js - Rückmeldung/Anfrage Daten der Messlokation (MeLo) (LF an NB)
// Segmentregeln für Prüf-ID 55626 (AHB Strom S2.1, Stand 29.06.2026, Stammdatenänderung).
...
const ahbRules55626 = {
    ...
    segments: [
        ...
        { id: "RFF_Z05", name: "SG6 RFF+Z05: Abrechnung des Messstellenbetriebs über NNE", status: "Soll", ahbExpr: "Soll [8]", rule: "AHB: Soll [8]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules55626;
