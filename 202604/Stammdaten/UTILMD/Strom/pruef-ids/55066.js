// 55066.js - Antwort auf Lieferantenclearingliste
// Segmentregeln für Prüf-ID 55066 (AHB Strom S2.1, Stand 29.06.2026, Kap. 13.2).
...
const ahbRules55066 = {
    ...
    segments: [
        ...
        { id: "LOC_Z15", name: "SG5 LOC+Z15: MaBiS-Zählpunkt", status: "Muss-bedingt", ahbExpr: "Muss [2140]", rule: "AHB: Muss [2140]" },
        { id: "RFF_AUU", name: "SG6 RFF+AUU: Versionsangabe der Summenzeitreihe", status: "Muss", rule: "AHB: Muss" },
        { id: "DTM_158", name: "SG4 DTM+158: Bilanzierungsbeginn", status: "Soll", ahbExpr: "Soll [31]", rule: "AHB: Soll [31]" },
        { id: "DTM_159", name: "SG4 DTM+159: Bilanzierungsende", status: "Soll", ahbExpr: "Soll [31]", rule: "AHB: Soll [31]" },
        { id: "LOC_Z16", name: "SG5 LOC+Z16: Marktlokation", status: "Muss-bedingt", ahbExpr: "Muss [2061] ∧ [348]", rule: "AHB: Muss [2061] ∧ [348]" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55066;
