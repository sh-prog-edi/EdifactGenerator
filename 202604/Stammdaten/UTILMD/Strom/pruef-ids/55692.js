// 55692.js - Rückmeldung/Anfrage Daten der Paket-ID der Marktlokation (NB-Wechsel) (NBN an NBA)
// Segmentregeln für Prüf-ID 55692 (AHB Strom S2.1, Stand 29.06.2026, Stammdatenänderung).
...
const ahbRules55692 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZZA", t: "ZZA - Änderung Paket-ID der MaLo" }], rule: "AHB: Muss" },
        { id: "RFF_Z47", name: "SG6 RFF+Z47: Verwendungszeitraum der Daten", status: "Muss-bedingt", ahbExpr: "Muss [315] ∧ [2080] Soll [8] ∧ [301] ∧ [2080]] · Codes: Z47 [5P0..1], Z48 [2P0..1], Z54 [4P0..1], Z55 [2P0..1]", rule: "AHB: Muss [315] ∧ [2080] Soll [8] ∧ [301] ∧ [2080]]" },
        { id: "DTM_Z25", name: "SG4 DTM+Z25: Verwendung der Daten ab", status: "Muss-bedingt", ahbExpr: "Muss [516]", rule: "AHB: Muss [516]" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55692;
