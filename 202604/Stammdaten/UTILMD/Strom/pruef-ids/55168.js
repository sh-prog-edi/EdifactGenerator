// 55168.js - Anfrage Verpflichtungsanfrage / Aufforderung (NB an gMSB) (NB an gMSB)
// Segmentregeln für Prüf-ID 55168 (AHB Strom S2.1, Stand 29.06.2026, Kap. 10 Messstellenbetrieb / WiM).
...
const ahbRules55168 = {
    ...
    segments: [
        ...
        { id: "DTM_752", name: "SG4 DTM+752: Turnusablesung des MSB", status: "Muss-bedingt", ahbExpr: "Muss [86] ∧ [78] ∧ [271] ∧ [618]", rule: "AHB: Muss [86] ∧ [78] ∧ [271] ∧ [618]" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55168;
