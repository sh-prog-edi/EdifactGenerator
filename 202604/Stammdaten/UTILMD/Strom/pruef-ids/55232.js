...
// Segmentregeln für Prüf-ID 55232 (AHB Strom S2.1, Stand 29.06.2026, Stammdatenänderung verantwortlich LF).
...
const ahbRules55232 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX5", t: "ZX5 - Änderung Blindabrechnungsdaten der NeLo" }], rule: "AHB: Muss" },
