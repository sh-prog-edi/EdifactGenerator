...
// Kern-Segmentregeln für Prüf-ID 55218 (AHB Strom S2.1, Abrechnungsdaten).
...
const ahbRules55218 = {
    ...
    segments: [
        ...
        { id: "DTM_Z09", name: "SG4 DTM+Z09: Nächste Netznutzungsabrechnung", status: "Muss-bedingt", ahbExpr: "Muss [489] ∧ [531]", rule: "AHB: Muss [489] ∧ [531]" },
        { id: "DTM_Z22", name: "SG4 DTM+Z22: Netznutzungsabrechnungsintervall des NB", status: "Muss", rule: "AHB: Muss" }
    ]
};
