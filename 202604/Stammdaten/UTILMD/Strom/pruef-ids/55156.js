...
// Kern-Segmentregeln für Prüf-ID 55156 (AHB Strom S2.1, Abrechnungsdaten).
...
const ahbRules55156 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX3", t: "ZX3 - Abrechnungsdaten BK-Abrechnung verbrauchender MaLo" }, { v: "ZAN", t: "ZAN - Korrektur Abrechnungsdaten BK-Abrechnung verbrauchender MaLo" }], ahbExpr: "Codes: ZAN [719]", rule: "AHB: Muss" },
