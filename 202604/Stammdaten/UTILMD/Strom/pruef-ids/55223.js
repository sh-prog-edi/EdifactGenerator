// 55223.js - DZÜ-Liste
// Segmentregeln für Prüf-ID 55223 (AHB Strom S2.1, Stand 29.06.2026, Kap. 13.8).
...
const ahbRules55223 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZP3", t: "ZP3 - Stammdaten" }, { v: "ZP4", t: "ZP4 - Werte" }], rule: "AHB: Muss" },
        ...
        { id: "RFF_AVE", name: "SG6 RFF+AVE: Referenz auf die ID der Bilanzierungsgebietssummenzeitreihe", status: "Muss", rule: "AHB: Muss" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules55223;
