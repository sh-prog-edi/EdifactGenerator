// 55040.js - Bestätigung Kündigung des Messstellenbetriebs (MSBA an MSBN)
// Segmentregeln für Prüf-ID 55040 (AHB Strom S2.1, Stand 29.06.2026, Kap. 10 Messstellenbetrieb / WiM).
...
const ahbRules55040 = {
    ...
    segments: [
        ...
        { id: "DTM_93", name: "SG4 DTM+93: Ende zum", status: "Muss-bedingt", ahbExpr: "Muss [12] ∧ [13]", rule: "AHB: Muss [12] ∧ [13]" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55040;
