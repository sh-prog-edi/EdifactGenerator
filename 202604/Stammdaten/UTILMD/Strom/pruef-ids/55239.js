// 55239.js - Antwort auf Anmeldung in Modell 2
// Segmentregeln für Prüf-ID 55239 (AHB Strom S2.1, Stand 29.06.2026, Kap. 11.1).
...
const ahbRules55239 = {
    ...
    segments: [
        ...
        { id: "LOC_Z16", name: "SG5 LOC+Z16: ID der Marktlokation", status: "Muss", ahbExpr: "Muss [56] ∧ [2061] ∧ [663]" },
        ...
        { id: "DTM_92", name: "SG4 DTM+92: Beginn zum", status: "Muss-bedingt", ahbExpr: "Muss [56]", rule: "AHB: Muss [56]" },
        { id: "DTM_158", name: "SG4 DTM+158: Bilanzierungsbeginn", status: "Muss-bedingt", ahbExpr: "Muss [56]", rule: "AHB: Muss [56]" },
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "E03", t: "E03 - Wechsel" }], rule: "AHB: Muss" },
        { id: "LOC_Z15", name: "SG5 LOC+Z15: MaBiS-Zählpunkt", status: "Muss-bedingt", ahbExpr: "Muss [56] ∧ [2061] ∧ [663]", rule: "AHB: Muss [56] ∧ [2061] ∧ [663]" },
        { id: "RFF_Z18", name: "SG6 RFF+Z18: Referenz auf die ID der Marktlokation", status: "Muss", rule: "AHB: Muss" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules55239;
