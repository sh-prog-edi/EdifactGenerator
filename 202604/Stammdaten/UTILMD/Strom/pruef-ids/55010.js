// 55010.js - Anfrage zur Beendigung der Zuordnung (LFA an LFN)
// Segmentregeln für Prüf-ID 55010 (AHB Strom S2.1, konsolidierte Lesefassung Stand 29.06.2026).
...
const ahbRules55010 = {
    ...
    segments: [
        ...
        { id: "STS_7", name: "SG4 STS+7: Transaktionsgrundergänzung", status: "Muss", isSelect: true, options: [{ v: "ZW3", t: "ZW3 - Erzeugende Marktlokation" }, { v: "ZW4", t: "ZW4 - Verbrauchende Marktlokation" }, { v: "ZW5", t: "ZW5 - Tranche" }, { v: "ZAP", t: "ZAP - ruhende Marktlokation" }], ahbExpr: "Codes: E01 [192]" },
        ...
        { id: "DTM_154", name: "SG4 DTM+154: ÜT der Lieferanmeldung des LFN", status: "Muss", rule: "AHB: Muss" },
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "E03", t: "E03 - Wechsel" }, { v: "E01", t: "E01 - Ein-/Auszug (Umzug)" }], ahbExpr: "Codes: E01 [192]", rule: "AHB: Muss" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55010;
