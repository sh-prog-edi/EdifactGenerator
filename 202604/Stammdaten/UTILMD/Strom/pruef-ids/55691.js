// 55691.js - Änderung Daten der Paket-ID der Marktlokation (NB-Wechsel) (NBA an NBN)
// Segmentregeln für Prüf-ID 55691 (AHB Strom S2.1, Stand 29.06.2026, Stammdatenänderung).
...
const ahbRules55691 = {
    ...
    segments: [
        ...
        { id: "RFF_Z49", name: "SG6 RFF+Z49: Verwendungszeitraum der Daten", status: "Muss-bedingt", ahbExpr: "Muss [2061] · Codes: Z49 [1P0..n], Z53 [8P0..n]", rule: "AHB: Muss [2061]" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55691;
