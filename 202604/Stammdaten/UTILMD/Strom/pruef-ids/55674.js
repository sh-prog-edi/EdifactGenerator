...
// Kern-Segmentregeln für Prüf-ID 55674 (AHB Strom S2.1, Abrechnungsdaten).
...
const ahbRules55674 = {
    ...
    segments: [
        ...
        { id: "STS_7", name: "SG4 STS+7: Transaktionsgrundergänzung", status: "Muss", isSelect: true, options: [{ v: "ZW3", t: "ZW3 - Erzeugende Marktlokation" }, { v: "ZW5", t: "ZW5 - Tranche" }, { v: "ZZB", t: "ZZB - Stilllegung incl. Stilllegung MaLo" }], ahbExpr: "Codes: ZAO [715], ZZB [328], ZZB [578], ZZB [313]", rule: "AHB: Muss" },
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX2", t: "ZX2 - Abrechnungsdaten BK-Abrechnung erzeugender Malo" }, { v: "ZAO", t: "ZAO - Korrektur Abrechnungsdaten BK-Abrechnung erzeugender MaLo" }], ahbExpr: "Codes: ZAO [715], ZZB [328], ZZB [578], ZZB [313]", rule: "AHB: Muss" },
