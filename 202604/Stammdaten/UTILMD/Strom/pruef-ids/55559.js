// 55559.js - Rückmeldung/Anfrage Daten der Messstellenbetriebsabrechnungsdaten der MaLo (NB an MSB)
// Segmentregeln für Prüf-ID 55559 (AHB Strom S2.1, Stand 29.06.2026, Stammdatenänderung verantwortlich MSB).
...
const ahbRules55559 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZU1", t: "ZU1 - Änderung von MSB Abrechnungsdaten" }], rule: "AHB: Muss" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55559;
