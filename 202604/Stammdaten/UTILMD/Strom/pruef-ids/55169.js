// 55169.js - Bestätigung Verpflichtungsanfrage / Aufforderung (NB an gMSB) (gMSB an NB)
// Segmentregeln für Prüf-ID 55169 (AHB Strom S2.1, Stand 29.06.2026, Kap. 10 Messstellenbetrieb / WiM).
...
const ahbRules55169 = {
    ...
    segments: [
        ...
        { id: "LOC_Z20", name: "SG5 LOC+Z20: Technische Ressource", status: "Soll", ahbExpr: "Soll [46] ∧ [672] ∧ [698]", rule: "AHB: Soll [46] ∧ [672] ∧ [698]" },
        ...
        { id: "DTM_752", name: "SG4 DTM+752: Turnusablesung des MSB", status: "Muss-bedingt", ahbExpr: "Muss [86] ∧ [271]", rule: "AHB: Muss [86] ∧ [271]" },
        ...
        { id: "RFF_Z34", name: "SG6 RFF+Z34: Referenz auf die ID der vorgelagerten Messlokation", status: "Soll", ahbExpr: "Soll [166] ∧ [668]", rule: "AHB: Soll [166] ∧ [668]" },
        { id: "RFF_Z16", name: "SG6 RFF+Z16: Referenz auf die der Messlokation zugeordneten Marktlokation", status: "Muss-bedingt", ahbExpr: "Muss [668]", rule: "AHB: Muss [668]" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55169;
