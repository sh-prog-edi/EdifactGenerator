// 55110.js - Änderung Daten der Marktlokation (MaLo) (LF an MSB)
// Segmentregeln für Prüf-ID 55110 (AHB Strom S2.1, Stand 29.06.2026, Stammdatenänderung verantwortlich LF).
...
const ahbRules55110 = {
    ...
    segments: [
        ...
        { id: "STS_7", name: "SG4 STS+7: Transaktionsgrundergänzung", status: "Muss", isSelect: true, options: [{ v: "ZW4", t: "ZW4 - Verbrauchende Marktlokation" }], rule: "AHB: Muss" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55110;
