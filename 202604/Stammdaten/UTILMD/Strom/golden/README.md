# Golden-Master — Formatstand 202604 (UTILMD Strom S2.1)

`messages.json` hält die erzeugten Nachrichten aller **187 Prüf-IDs** dieses Ziels
...
```bash
EDIGEN_TARGET=202604/Stammdaten/UTILMD/Strom node _engine/tests/golden.js
EDIGEN_TARGET=202604/Stammdaten/UTILMD/Strom node _engine/tests/golden.js --update
```
