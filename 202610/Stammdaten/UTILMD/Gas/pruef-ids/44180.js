// 44180.js  (UTILMD Gas) - Anfrage der Marktlokationsstruktur
...
const ahbRules44180 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss-bedingt", isSelect: true, options: [{ v: "ZJ1", t: "ZJ1 - Anfrage der komplexen Marktlokationsstruktur" }], ahbExpr: "Muss [2061]", rule: "AHB: Muss [2061]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules44180;
