// 44012.js  (UTILMD Gas, GeLi Gas) - Abmeldeanfrage – Ablehnung (NB an LF)
...
const ahbRules44012 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss-bedingt", isSelect: true, options: [{ v: "E01", t: "E01 - Ein-/Auszug (Umzug)" }, { v: "E03", t: "E03 - Wechsel" }, { v: "ZD2", t: "ZD2 - Lieferbeginn und Abmeldung aus der Ersatzversorgung" }], ahbExpr: "Muss [2061]", rule: "AHB: Muss [2061]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules44012;
