// 44150.js  (UTILMD Gas) - Bila. rel. Anfrage an LF
...
const ahbRules44150 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss-bedingt", isSelect: true, options: [{ v: "ZF6", t: "ZF6 - Bila.rel. Anfrage an LF" }], ahbExpr: "Muss [2061]", rule: "AHB: Muss [2061]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules44150;
