// 44024.js  (UTILMD Gas, GeLi Gas) - Ablehnung Anfrage Stornierung
// Segmentregeln für Prüf-ID 44024 (AHB Gas G1.2, Fehlerkorrektur 29.06.2026).
...
const ahbRules44024 = {
    ...
    segments: [
        ...
        { id: "RFF_Z13", name: "SG6 RFF+Z13: Prüfidentifikator (44024)", status: "Muss" },
...
if (typeof module !== 'undefined') module.exports = ahbRules44024;
