// 44037.js  (UTILMD Gas, GeLi Gas) - Informationsmeldung Beendigung Zuordnung (NB an LF)
...
const ahbRules44037 = {
    ...
    segments: [
        ...
        { id: "DTM_93", name: "SG4 DTM+93: Termin der Zuordnung/Beendigung", status: "Muss" },
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss-bedingt", isSelect: true, options: [{ v: "ZC8", t: "ZC8 - Beendigung der Zuordnung" }], ahbExpr: "Muss [2061]", rule: "AHB: Muss [2061]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules44037;
