// 44002.js  (UTILMD Gas, GeLi Gas) - Anmeldung – Bestätigung (NB an LF)
...
const ahbRules44002 = {
    ...
    segments: [
        ...
        { id: "RFF_AVC", name: "SG6 RFF+AVC: Kundennummer beim Lieferanten", status: "Soll", ahbExpr: "Soll [147]", rule: "AHB: Soll [147]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules44002;
