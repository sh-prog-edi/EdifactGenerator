// 44156.js  (UTILMD Gas) - Bila.rel. Anfrage an NB mit
...
const ahbRules44156 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss-bedingt", isSelect: true, options: [{ v: "ZF8", t: "ZF8 - Bila.rel. Anfrage an NB mit Abhängigkeiten" }], ahbExpr: "Muss [2061]", rule: "AHB: Muss [2061]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules44156;
