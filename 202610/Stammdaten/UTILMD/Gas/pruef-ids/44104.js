// 44104.js  (UTILMD Gas) - Aktualisierte Stammdaten zur
...
const ahbRules44104 = {
    ...
    segments: [
        ...
        { id: "DTM_158", name: "SG4 DTM+158: Bilanzierungsbeginn", status: "Muss-bedingt", ahbExpr: "Muss [9]", rule: "AHB: Muss [9]" },
        { id: "DTM_159", name: "SG4 DTM+159: Bilanzierungsende", status: "Muss-bedingt", ahbExpr: "Muss [9] ∧ [28] ∧ [64]", rule: "AHB: Muss [9] ∧ [28] ∧ [64]" },
...
if (typeof module !== 'undefined') module.exports = ahbRules44104;
