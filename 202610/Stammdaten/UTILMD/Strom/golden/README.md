# Golden-Master — Formatstand 202610 (UTILMD Strom S2.2)

`messages.json` hält die erzeugten Nachrichten aller **189 Prüf-IDs** dieses Ziels
...
```bash
EDIGEN_TARGET=202610/Stammdaten/UTILMD/Strom node _engine/tests/golden.js
EDIGEN_TARGET=202610/Stammdaten/UTILMD/Strom node _engine/tests/golden.js --update
```
