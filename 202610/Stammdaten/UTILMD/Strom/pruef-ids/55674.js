// 55674.js - Bilanzkreisabrechnung erzeugende MaLo (NB an ÜNB)
// Kern-Segmentregeln für Prüf-ID 55674 (AHB Strom V2.2, Abrechnungsdaten).
...
const ahbRules55674 = {
    ...
    segments: [
        ...
        { id: "DTM_Z25", name: "SG6 DTM+Z25: Verwendung der Daten ab (Verwendungszeitraum-Beginn)", status: "Muss", ahbExpr: "[146]) ⊻ ([132] ∧ [145]) ⊻ [401]" },
        ...
        { id: "STS_7", name: "SG4 STS+7: Transaktionsgrundergänzung", status: "Muss", isSelect: true, options: [{ v: "ZW3", t: "ZW3 - Erzeugende Marktlokation" }, { v: "ZW5", t: "ZW5 - Tranche" }, { v: "ZZB", t: "ZZB - Stilllegung incl. Stilllegung MaLo" }], ahbExpr: "Codes: ZAO [715], ZZB [328], ZZB [578]", rule: "AHB: Muss" },
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX2", t: "ZX2 - Abrechnungsdate n BK-Abrechnung erzeugender Malo" }, { v: "ZAO", t: "ZAO - Korrektur Abrechnungsdate n BK-Abrechnung erzeugender MaLo" }], ahbExpr: "Codes: ZAO [715], ZZB [328], ZZB [578]", rule: "AHB: Muss" },
        ...
        { id: "RFF_Z49", name: "SG6 RFF+Z49: der Daten", status: "Muss-bedingt", ahbExpr: "Muss [707] ∧ [534] · Codes: Z49 [1P0..n], Z53 [1P0..n]", rule: "AHB: Muss [707] ∧ [534]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules55674;
