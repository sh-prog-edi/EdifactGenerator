...
// Segmentregeln für Prüf-ID 55013 (AHB Strom, Version 2.2, 29.06.2026).
...
const ahbRules55013 = {
    ...
    segments: [
        ...
        { id: "STS_7", name: "SG4 STS+7: Transaktionsgrundergänzung", status: "Muss", isSelect: true, options: [{ v: "ZW6", t: "ZW6 - Pauschale Marktlokation" }, { v: "ZW7", t: "ZW7 - Gemessene Marktlokation" }], ahbExpr: "Codes: E06 [580], ZZD [681], E01 [9P0..1], E03 [9P0..1]" },
