// 55614.js - Rückmeldung Bilanzkreisabrechnung verb. MaLo (ÜNB an NB)
// Kern-Segmentregeln für Prüf-ID 55614 (AHB Strom V2.2, Abrechnungsdaten).
...
const ahbRules55614 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX3", t: "ZX3 - Abrechnungsdate n BK-Abrechnung verbrauchender MaLo" }, { v: "ZAN", t: "ZAN - Korrektur Abrechnungsdate n BK-Abrechnung verbrauchender MaLo" }], rule: "AHB: Muss" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55614;
