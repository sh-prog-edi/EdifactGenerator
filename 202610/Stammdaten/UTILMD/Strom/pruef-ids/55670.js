...
// Segmentregeln für Prüf-ID 55670 (AHB Strom V2.2, 29.06.2026, Kap. 9.4 Bilanzkreistreue).
...
const ahbRules55670 = {
    ...
    segments: [
        ...
        { id: "STS_7", name: "SG4 STS+7: Transaktionsgrundergänzung", status: "Muss", isSelect: true, options: [{ v: "ZW3", t: "ZW3 - Erzeugende Marktlokation" }, { v: "ZW4", t: "ZW4 - Verbrauchende Marktlokation" }, { v: "ZW5", t: "ZW5 - Tranche" }, { v: "ZZB", t: "ZZB - Stilllegung incl. Stilllegung MaLo" }], ahbExpr: "Codes: ZZB [328], ZZB [578]" },
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZAM", t: "ZAM - Stammdaten BK-Treue" }], ahbExpr: "Codes: ZZB [328], ZZB [578]", rule: "AHB: Muss" },
        ...
        { id: "DTM_Z25", name: "SG4 DTM+Z25: ab", status: "Muss-bedingt", ahbExpr: "Muss [131] ⊻ [401]", rule: "AHB: Muss [131] ⊻ [401]" },
