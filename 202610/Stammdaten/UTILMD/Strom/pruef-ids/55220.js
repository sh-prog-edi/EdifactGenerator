...
// Kern-Segmentregeln für Prüf-ID 55220 (AHB Strom V2.2, Abrechnungsdaten).
...
const ahbRules55220 = {
    ...
    segments: [
        ...
        { id: "RFF_Z47", name: "SG6 RFF+Z47: Verwendungszeitraum der Daten", status: "Soll", ahbExpr: "Soll [8] ∧ [301] ∧ [707] · Codes: Z47 [5P0..n], Z48 [2P0..n], Z54 [4P0..n], Z55 [2P0..n]", rule: "AHB: Soll [8] ∧ [301] ∧ [707]" },
        ...
        { id: "DTM_Z22", name: "SG4 DTM+Z22: sintervall des NB", status: "Soll", ahbExpr: "Soll [8]", rule: "AHB: Soll [8]" }
    ]
};
