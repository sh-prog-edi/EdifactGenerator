...
// Segmentregeln für Prüf-ID 55169 (AHB Strom V2.2, 29.06.2026, Kap. 10 Messstellenbetrieb / WiM).
...
const ahbRules55169 = {
    ...
    segments: [
        ...
        { id: "DTM_752", name: "SG4 DTM+752: Turnusablesung des MSB", status: "Muss-bedingt", ahbExpr: "Muss [234]", rule: "AHB: Muss [234]" },
        ...
        { id: "RFF_Z37", name: "SG6 RFF+Z37: Technischen Ressource", status: "Muss", rule: "AHB: Muss" },
        { id: "RFF_Z38", name: "SG6 RFF+Z38: Referenz auf die ID der Steuerbaren Ressource", status: "Muss", rule: "AHB: Muss" },
        { id: "RFF_Z19", name: "SG6 RFF+Z19: Messlokation", status: "Muss", rule: "AHB: Muss" },
