...
// Kern-Segmentregeln für Prüf-ID 55672 (AHB Strom V2.2, Abrechnungsdaten).
...
const ahbRules55672 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX2", t: "ZX2 - Abrechnungsdate n BK-Abrechnung erzeugender Malo" }, { v: "ZAO", t: "ZAO - Korrektur Abrechnungsdate n BK-Abrechnung erzeugender MaLo" }], ahbExpr: "Codes: ZAO [715]", rule: "AHB: Muss" },
