// 55673.js - Rückmeldung Bilanzkreisabrechnung erz. MaLo (LF an NB)
// Kern-Segmentregeln für Prüf-ID 55673 (AHB Strom V2.2, Abrechnungsdaten).
...
const ahbRules55673 = {
    ...
    segments: [
        ...
        { id: "STS_E01", name: "SG4 STS+E01: Status der Rückmeldung (EBD E_0611)", status: "Muss" },
        ...
        { id: "STS_7", name: "SG4 STS+7: Transaktionsgrundergänzung", status: "Muss", isSelect: true, options: [{ v: "ZW3", t: "ZW3 - Erzeugende Marktlokation" }, { v: "ZW5", t: "ZW5 - Tranche" }], ahbExpr: "Codes: ZAO [719]", rule: "AHB: Muss" },
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX2", t: "ZX2 - Abrechnungsdate n BK-Abrechnung erzeugender Malo" }, { v: "ZAO", t: "ZAO - Korrektur Abrechnungsdate n BK-Abrechnung erzeugender MaLo" }], ahbExpr: "Codes: ZAO [719]", rule: "AHB: Muss" },
        ...
        { id: "RFF_Z47", name: "SG6 RFF+Z47: der Daten", status: "Muss-bedingt", ahbExpr: "Muss [315] ∧ [707] Soll [8] ∧ [301] ∧ [707] · Codes: Z47 [5P0..n], Z48 [2P0..n], Z54 [4P0..n], Z55 [2P0..n]", rule: "AHB: Muss [315] ∧ [707] Soll [8] ∧ [301] ∧ [707]" },
        { id: "DTM_Z25", name: "SG4 DTM+Z25: Verwendung der Daten ab", status: "Bedingt", ahbExpr: "[135]", rule: "AHB: [135]" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55673;
