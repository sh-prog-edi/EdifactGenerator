// 55686.js - Änderung Daten der Tranche an ÜNB (MSB an ÜNB)
// Segmentregeln für Prüf-ID 55686 (AHB Strom V2.2, 29.06.2026, Stammdatenänderung verantwortlich MSB).
...
const ahbRules55686 = {
    ...
    segments: [
        ...
        { id: "RFF_Z49", name: "SG6 RFF+Z49: Verwendungszeitraum der Daten", status: "Bedingt", ahbExpr: "∧ [534] · Codes: Z49 [1P0..n], Z53 [1P0..n]", rule: "AHB: ∧ [534]" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55686;
