// 55675.js - Rückmeldung Bilanzkreisabrechnung erz. MaLo (ÜNB an NB)
// Kern-Segmentregeln für Prüf-ID 55675 (AHB Strom V2.2, Abrechnungsdaten).
...
const ahbRules55675 = {
    ...
    segments: [
        ...
        { id: "STS_7", name: "SG4 STS+7: Transaktionsgrundergänzung", status: "Muss", isSelect: true, options: [{ v: "ZW3", t: "ZW3 - Erzeugende Marktlokation" }, { v: "ZW5", t: "ZW5 - Tranche" }], rule: "AHB: Muss" },
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX2", t: "ZX2 - Abrechnungsdate n BK-Abrechnung erzeugender Malo" }, { v: "ZAO", t: "ZAO - Korrektur Abrechnungsdate n BK-Abrechnung erzeugender MaLo" }], rule: "AHB: Muss" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55675;
