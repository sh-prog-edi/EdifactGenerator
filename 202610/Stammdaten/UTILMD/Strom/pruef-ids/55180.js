// 55180.js - Rückmeldung/Anfrage Daten der Lokationsbündelstruktur (LF an NB)
// Segmentregeln für Prüf-ID 55180 (AHB Strom V2.2, 29.06.2026, Stammdatenänderung).
...
const ahbRules55180 = {
    ...
    segments: [
        ...
        { id: "LOC_Z18", name: "SG5 LOC+Z18: ID der Netzlokation", status: "Muss", ahbExpr: "Soll [8]" },
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZY2", t: "ZY2 - Änderung der Lokationsbündel struktur" }], rule: "AHB: Muss" },
        { id: "LOC_Z16", name: "SG5 LOC+Z16: Marktlokation", status: "Soll", ahbExpr: "Soll [8]", rule: "AHB: Soll [8]" },
        { id: "LOC_Z22", name: "SG5 LOC+Z22: Ruhende Marktlokation", status: "Soll", ahbExpr: "Soll [2015]", rule: "AHB: Soll [2015]" },
        { id: "LOC_Z20", name: "SG5 LOC+Z20: Technische Ressource", status: "Soll", ahbExpr: "Soll [8]", rule: "AHB: Soll [8]" },
        { id: "LOC_Z19", name: "SG5 LOC+Z19: Steuerbare Ressource", status: "Soll", ahbExpr: "Soll [8]", rule: "AHB: Soll [8]" },
        { id: "LOC_Z17", name: "SG5 LOC+Z17: Messlokation", status: "Soll", ahbExpr: "Soll [8]", rule: "AHB: Soll [8]" },
        ...
        { id: "RFF_Z33", name: "SG6 RFF+Z33: Referenz auf den Objektcode in der Lokationsbündelstrukt ur", status: "Muss-bedingt", ahbExpr: "Muss [2313]", rule: "AHB: Muss [2313]" },
        { id: "RFF_Z34", name: "SG6 RFF+Z34: Referenz auf die ID der vorgelagerten Netzlokation / Messlokation", status: "Muss-bedingt", ahbExpr: "Muss ([176] ∧ (([173] ∧ [179]) ⊻ ([174] ∧ [196]))) ⊻ ([177] ∧ [178] ∧ [229])", rule: "AHB: Muss ([176] ∧ (([173] ∧ [179]) ⊻ ([174] ∧ [196]))) ⊻ ([177] ∧ [178] ∧ [229])" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55180;
