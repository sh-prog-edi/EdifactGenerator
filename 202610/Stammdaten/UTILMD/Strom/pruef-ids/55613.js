...
// Kern-Segmentregeln für Prüf-ID 55613 (AHB Strom V2.2, Abrechnungsdaten).
...
const ahbRules55613 = {
    ...
    segments: [
        ...
        { id: "STS_7", name: "SG4 STS+7: Transaktionsgrundergänzung", status: "Muss", isSelect: true, options: [{ v: "ZZB", t: "ZZB - Stilllegung incl. Stilllegung MaLo" }], ahbExpr: "Codes: ZAN [715], ZZB [328], ZZB [578]", rule: "AHB: Muss" },
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX3", t: "ZX3 - Abrechnungsdate n BK-Abrechnung verbrauchender MaLo" }, { v: "ZAN", t: "ZAN - Korrektur Abrechnungsdate n BK-Abrechnung verbrauchender MaLo" }], ahbExpr: "Codes: ZAN [715], ZZB [328], ZZB [578]", rule: "AHB: Muss" },
