// 55232.js - Rückmeldung/Anfrage Daten der Blindabrechnungsdaten der NeLo (NB an LF)
// Segmentregeln für Prüf-ID 55232 (AHB Strom V2.2, 29.06.2026, Stammdatenänderung verantwortlich LF).
...
const ahbRules55232 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX5", t: "ZX5 - Änderung Blindabrechnungsdate n der NeLo" }], rule: "AHB: Muss" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55232;
