// 55635.js - Rückmeldung/Anfrage Daten der Technische Ressource (TR) (MSB an NB)
// Segmentregeln für Prüf-ID 55635 (AHB Strom V2.2, 29.06.2026, Stammdatenänderung).
...
const ahbRules55635 = {
    ...
    segments: [
        ...
        { id: "RFF_Z38", name: "SG6 RFF+Z38: Referenz auf die der Technischen Ressource zugeordneten Steuerbaren Ressource", status: "Soll", ahbExpr: "Soll [8]", rule: "AHB: Soll [8]" },
        { id: "RFF_Z32", name: "SG6 RFF+Z32: Referenz auf die der Technischen Ressource zugeordneten Netzlokation", status: "Soll", ahbExpr: "Soll [8]", rule: "AHB: Soll [8]" },
        { id: "RFF_Z20", name: "SG6 RFF+Z20: Referenz auf die der Technischen Ressource zugeordneten Tranche", status: "Soll", ahbExpr: "Soll [8]", rule: "AHB: Soll [8]" }
    ]
};

if (typeof module !== 'undefined') module.exports = ahbRules55635;
