// 55156.js - Rückmeldung Bilanzkreisabrechnung verb. MaLo (LF an NB)
// Kern-Segmentregeln für Prüf-ID 55156 (AHB Strom V2.2, Abrechnungsdaten).
...
const ahbRules55156 = {
    ...
    segments: [
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZX3", t: "ZX3 - Abrechnungsdate n BK-Abrechnung verbrauchender MaLo" }, { v: "ZAN", t: "ZAN - Korrektur Abrechnungsdate n BK-Abrechnung verbrauchender MaLo" }], ahbExpr: "Codes: ZAN [719]", rule: "AHB: Muss" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55156;
