// 55690.js - Änderung Daten der Lokationsbündelstruktur (NBA an NBN)
// Segmentregeln für Prüf-ID 55690 (AHB Strom V2.2, 29.06.2026, Stammdatenänderung).
...
const ahbRules55690 = {
    ...
    segments: [
        ...
        { id: "LOC_Z16", name: "SG5 LOC+Z16: Marktlokation", status: "Muss-bedingt", ahbExpr: "Muss [678]", rule: "AHB: Muss [678]" },
        { id: "LOC_Z22", name: "SG5 LOC+Z22: Ruhende Marktlokation", status: "Soll", ahbExpr: "Soll [2015]", rule: "AHB: Soll [2015]" },
        { id: "LOC_Z20", name: "SG5 LOC+Z20: Technische Ressource", status: "Soll", ahbExpr: "Soll [46] ∧ [679] ∧ [694] ∧ [698]", rule: "AHB: Soll [46] ∧ [679] ∧ [694] ∧ [698]" },
        { id: "LOC_Z19", name: "SG5 LOC+Z19: Steuerbare Ressource", status: "Soll", ahbExpr: "Soll [46] ∧ [680]", rule: "AHB: Soll [46] ∧ [680]" },
        { id: "LOC_Z21", name: "SG5 LOC+Z21: Tranche", status: "Soll", ahbExpr: "Soll [166]", rule: "AHB: Soll [166]" },
        { id: "LOC_Z17", name: "SG5 LOC+Z17: Messlokation", status: "Muss-bedingt", ahbExpr: "Muss ([399] ⊻ [202]) ∧ [682]", rule: "AHB: Muss ([399] ⊻ [202]) ∧ [682]" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55690;
