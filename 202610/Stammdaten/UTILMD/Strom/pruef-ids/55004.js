...
// Segmentregeln für Prüf-ID 55004 (AHB Strom, Version 2.2, 29.06.2026).
...
const ahbRules55004 = {
    ...
    segments: [
        ...
        { id: "STS_7", name: "SG4 STS+7: Transaktionsgrundergänzung", status: "Muss", isSelect: true, options: [{ v: "ZW3", t: "ZW3 - Erzeugende Marktlokation" }, { v: "ZW4", t: "ZW4 - Verbrauchende Marktlokation" }, { v: "ZW5", t: "ZW5 - Tranche" }, { v: "ZAP", t: "ZAP - ruhende Marktlokation" }], ahbExpr: "Codes: E01 [18P0..1], Z33 [1P0..1], Z41 [1P0..1], Z41 [510], ZG9 [18P0..1], ZH1 [1P0..1], ZH2 [1P0..1], ZT4 [1P0..1], ZT5 [1P0..1], ZZD [1P0..1], ZZD [686]" },
