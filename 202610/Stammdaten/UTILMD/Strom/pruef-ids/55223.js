// 55223.js - DZÜ-Liste
// Segmentregeln für Prüf-ID 55223 (AHB Strom V2.2, 29.06.2026, Kap. 13.8).
...
const ahbRules55223 = {
    ...
    segments: [
        ...
        { id: "RFF_AVE", name: "SG6 RFF+AVE: Referenz auf die ID der Bilanzierungsgebietssu mmenzeitreihe", status: "Muss", rule: "AHB: Muss" }
    ]
};
