// 55687.js - Rückmeldung/Anfrage Daten der Tranche an ÜNB (ÜNB an MSB)
// Segmentregeln für Prüf-ID 55687 (AHB Strom V2.2, 29.06.2026, Stammdatenänderung verantwortlich MSB).
...
const ahbRules55687 = {
    ...
    segments: [
        ...
        { id: "LOC_Z21", name: "SG5 LOC+Z21: ID der Tranche", status: "Muss", ahbExpr: "Muss [2061]" },
        ...
        { id: "STS_7_grund", name: "SG4 STS+7: Transaktionsgrund", status: "Muss", isSelect: true, options: [{ v: "ZY1", t: "ZY1 - Änderung Daten der Tranche" }], rule: "AHB: Muss" },
        { id: "RFF_Z47", name: "SG6 RFF+Z47: Verwendungszeitraum der Daten", status: "Bedingt", ahbExpr: "∧ [707] Soll [8] ∧ [301] ∧ [707] · Codes: Z47 [5P0..n], Z48 [2P0..n], Z54 [4P0..n], Z55 [2P0..n]", rule: "AHB: ∧ [707] Soll [8] ∧ [301] ∧ [707]" },
...
if (typeof module !== 'undefined') module.exports = ahbRules55687;
