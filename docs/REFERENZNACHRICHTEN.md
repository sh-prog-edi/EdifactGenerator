...
1. **Echte EDIFACT-Dateien** aus der Marktpartner-Kommunikation, als Roh-Text
   ...
   - Bevorzugt **UTILMD Strom/Gas** (Kerngeschäft des Werkzeugs), gern beide
     Formatstände; dazu jede andere verfügbare Art (MSCONS, ORDERS/ORDRSP,
     INVOIC/REMADV, APERAK/CONTRL …).
   - Je Prozess/Prüf-ID genügt zunächst EINE Nachricht; Breite schlägt Tiefe.
